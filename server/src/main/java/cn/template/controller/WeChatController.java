...
import cn.template.pojo.wechat.UrlParam;
import cn.template.pojo.wechat.xml.WeChatXML;
import cn.template.pojo.wechat.xml.event.EventType;
import cn.template.service.wechat.event.WeChatService;
import cn.template.service.wechat.event.impl.event.BaseEventServiceImpl;
import cn.template.util.DataConverUtils;
import cn.template.util.SysResources;
import cn.template.util.WeChatUtils;
...
public class WeChatController {
    ...
    public WeChatController(@Value("${wechat.token}") String token,
        ...
        log.debug("token:"+token+"|appid:"+appId+"|aeskey:"+encodingAesKey);
        SysResources.appId=appId;
        SysResources.appSecret=appSecret;
    }
    ...
    public String wechat(@RequestBody String body, UrlParam params,
        ...
        // 解析xml为字符串
        String responseXml = DataConverUtils.ObjectToXML(xml);

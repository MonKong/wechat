package cn.template.service.wechat.event;
...
//		reqClazz = (Class) type.getActualTypeArguments()[0];
     ...
     * @date 2014年12月10日
     */
    public WeChatXML process(reqT reqBean) throws Exception {
     ...
     * @date 2014年12月10日
     */
    public abstract WeChatXML service(reqT req, respT resq) throws Exception;
